"""Dev one-stage video generation pipeline (full resolution + CFG).

Mirrors upstream ``ltx_pipelines.ti2vid_one_stage.TI2VidOneStagePipeline``
1:1: dev (non-distilled) transformer + CFG/STG guidance, run **once at
...
class DevOneStagePipeline(TwoStagePipeline):
